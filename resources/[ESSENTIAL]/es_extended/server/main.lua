...
AddEventHandler('esx:onPickup', function(id)
	...
	if pickup.type == 'item_standard' then
		...
		if total > 0 then
			--TriggerClientEvent('esx:showNotification', _source, "Vous avez ramassé ~g~"..total..""..pickup.name.."~s~.")
	...
	elseif pickup.type == 'item_money' then
		TriggerClientEvent('esx:removePickup', -1, id)
		TriggerClientEvent('esx:showNotification', _source, "Vous avez ramassé ~g~"..pickup.count.."$~g~.")
