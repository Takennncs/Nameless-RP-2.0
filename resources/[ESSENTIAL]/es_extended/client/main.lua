...
AddEventHandler('esx:pickup', function(id, label, player)
	...
	ESX.Game.SpawnLocalObject('v_serv_abox_02', { -- hei_prop_heist_weed_block_01
		x = x,
		y = y,
		z = z,
	}, function(obj)
		...
		for k,v in pairs(pickups) do
			...
			if distance < 1 then
				if IsControlJustReleased(0, 38) then
					...
					if IsPedOnFoot(playerPed) and (closestDistance == -1 or closestDistance > 0) and not v.inRange then
