Locales['fr'] = {
  ...
  ['noammo'] = '~r~Tu n\'as pas toutes ces munitions.',
  ['gave_item'] = 'Vous avez donné ~g~%s~s~ ~g~%s~s~ à ~g~quelqu\'un.',
  ['received_item'] = '~g~Quelqu\'un ~s~vous a donné ~g~%s~s~ ~g~%s~s~.',
  ['gave_weapon'] = 'Vous avez donné ~g~1~s~ ~g~%s~s~ à ~g~quelqu\'un.',
  ['gave_weapon_ammo'] = 'Vous avez donné ~g~1~s~ ~g~%s~s~ avec ~g~%s~s~ balles à ~g~quelqu\'un.',
  ...
  ['gave_ammo'] = 'Vous avez donné ~g~%s munitions ~s~à ~g~quelqu\'un.',
  ['received_ammo'] = 'Quelqu\'un ~s~vous a donné ~g~%s~s~ munitions.',
  ['gave_money'] = 'Vous avez donné ~g~$%s~s~ à ~g~quelqu\'un.',
  ['received_money'] = '~g~Quelqu\'un ~s~vous a donné ~g~$%s~s~.',
  ['gave_account_money'] = 'Vous avez donné ~g~$%s~s~ (%s) à ~g~quelqu\'un.',
  ['received_account_money'] = '~g~Quelqu\'un ~s~vous a donné ~g~$%s~s~.',
  ['amount_invalid'] = '~r~Montant invalide.',
  ['players_nearby'] = '~r~Aucunne personne à proximité.',
  ['ex_inv_lim'] = '~r~la personne a les poches pleines.',
  ['imp_invalid_quantity'] = '~r~Quantité invalide.',
  ['imp_invalid_amount'] = '~r~Montant invalide.',
  ['threw_standard'] = 'Vous avez jeté ~g~%s~s~ ~g~%s~s~.',
  ['threw_money'] = 'Vous avez jeté ~g~$%s~s~.',
  ['threw_account'] = 'Vous avez jeté ~g~$%s~s~.',
  ['threw_weapon'] = 'Vous avez jeté ~g~1~s~ ~g~%s~s~.',
  ['threw_weapon_ammo'] = 'Vous avez jeté ~g~1~s~ ~g~%s~s~ avec ~g~%s ~s~balles.',
  -- Salary related
  ['received_salary'] = 'Jour de paye ~g~+ %s$~s~',
  ['received_help'] = 'Jour de paye ~g~+ %s$~s~',
  ['company_nomoney'] = '~s~Entreprise\n~r~Plus d\'argent.',
  ...
  ['cannot_pickup_room'] = '~r~Vous n\'avez plus de place pour ~w~%s~s~.',
  ...
  ['weapon_ball'] = 'Balle',
  ['weapon_snspistol'] = 'Pistolet à billes',
