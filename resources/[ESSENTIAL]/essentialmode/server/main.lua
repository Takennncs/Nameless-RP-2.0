...
AddEventHandler('playerConnecting', function(name, setKickReason)
	...
	if not id then
		setKickReason("Impossible de trouver votre SteamID, merci de relancer FiveM avec Steam d'ouvert ou relancer FiveM et Steam si il est déjà ouvert.")
		CancelEvent()
	end
end)
...
AddEventHandler('es:firstJoinProper', function()
	...
	Citizen.CreateThread(function()
		...
		if not id then
			DropPlayer(Source, "SteamID introuvable, merci de vous reconnecter avec.")
		else
