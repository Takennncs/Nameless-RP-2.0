...
function sendToDiscord(msg)
    if Config.discord_webhook~=nil then
        PerformHttpRequest(Config.discord_webhook, function(a,b,c)end, "POST", json.encode({embeds={{title="Logs Nameless RP",description=msg:gsub("%^%d",""),color=65280,}}}), {["Content-Type"]="application/json"})
    end
end
...
RegisterServerEvent("el_bwh:caban")
AddEventHandler("el_bwh:caban",function()
    TriggerClientEvent("el_bwh:showWindow",source,"ban")
end)

RegisterServerEvent("el_bwh:cawarn")
AddEventHandler("el_bwh:cawarn",function()
    TriggerClientEvent("el_bwh:showWindow",source,"warn")
end)

RegisterServerEvent("el_bwh:cabanlist")
AddEventHandler("el_bwh:cabanlist",function()
    TriggerClientEvent("el_bwh:showWindow",source,"banlist")
end)

RegisterServerEvent("el_bwh:cawarnlist")
AddEventHandler("el_bwh:cawarnlist",function()
    TriggerClientEvent("el_bwh:showWindow",source,"warnlist")
end)
