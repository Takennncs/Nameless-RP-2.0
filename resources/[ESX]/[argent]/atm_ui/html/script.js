...
$('.close').click(function () {
    ...
    $.post('http://atm_ui/NUIFocusOff', JSON.stringify({}));
});

$('#withdraw').click(function (e) {
    e.preventDefault();
    $.post('http://atm_ui/withdrawl', JSON.stringify({
...
$('#deposit').click(function (e) {
    e.preventDefault();
    $.post('http://atm_ui/deposit', JSON.stringify({
...
$('#transfer').click(function (e) {
    e.preventDefault();
    $.post('http://atm_ui/transfer', JSON.stringify({
        to: $('#idval').val(),
