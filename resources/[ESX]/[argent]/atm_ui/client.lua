...
local bankLocations = {
    {i = 434, c = 2, x = 241.727, y = 220.706, z = 106.286, s = 0.6, n = "Banque"}, -- blip id, blip color, x, y, z, scale, name/label
	{i = 434, c = 2, x = 150.266, y = -1040.203, z = 29.374, s = 0.6, n = "Banque"},
	{i = 434, c = 2, x = -1212.980, y = -330.841, z = 37.787, s = 0.6, n = "Banque"},
	{i = 434, c = 2, x = -2962.582, y = 482.627, z = 15.703, s = 0.6, n = "Banque"},
	{i = 434, c = 2, x = -112.202, y = 6469.295, z = 31.626, s = 0.6, n = "Banque"},
	{i = 434, c = 2, x = 314.187, y = -278.621, z = 54.170, s = 0.6, n = "Banque"},
	{i = 434, c = 2, x = -351.534, y = -49.529, z = 49.042, s = 0.6, n = "Banque"},
	{i = 434, c = 2, x = 1175.0643310547, y = 2706.6435546875, z = 38.094036102295, s = 0.6, n = "Banque"}
}
...
Citizen.CreateThread(function()
    while true do
        ...
        if playerNearBank() and not inMenu then
            DisplayHelpText("Appuyez sur ~INPUT_PICKUP~ pour ~g~accéder à l'atm")
...
function openPlayersBank(type, color)
    ...
    exports["a_loadingbar"]:StartDelayedFunction('Insertion de la carte...', time, function() end) 
    Citizen.Wait(time)
    ClearPedTasks(ped)
    if type == 'bank' then
        inMenu = true
...
RegisterNUICallback('deposit', function(data)
    if not atATM then
        ...
        ESX.ShowNotification("Vous ne pouvez ~g~pas déposer ~s~à un ~g~ATM.")
    end
end)
...
function closePlayersBank()
    ...
    TaskPlayAnim(ped, dict, anim, 8.0, 8.0, -1, 0, 0, 0, 0, 0)
    exports["a_loadingbar"]:StartDelayedFunction('Retrait de la carte...', time, function() end) 
    Citizen.Wait(time)
    ClearPedTasks(ped)
    inMenu = false
end
