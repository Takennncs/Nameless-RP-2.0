...
ESX.RegisterServerCallback('esx_society:setJob', function(source, cb, identifier, job, grade, type)
	...
	local isLTD = xPlayer.job.grade_name == 'gerant'

	if isBoss or isLTD then
...
function isPlayerBoss(playerId, job)
	...
	if xPlayer.job.name == job and xPlayer.job.grade_name == 'boss' or xPlayer.job.grade_name == 'gerant' then
		return true
	else
...
RegisterServerEvent('esx_society:check_money')
AddEventHandler('esx_society:check_money', function(society)
	-- local xPlayer 		= ESX.GetPlayerFromId(source)
	-- local society 		= GetSociety(xPlayer.job.name)
	local societyname 		= ('society_'..society..'')
	-- print(society)
	-- print(societyname)
	if society ~= nil then
	...
	TriggerClientEvent('esx:showNotification', source, '~g~Société.\n~s~Votre société à ~g~' .. money .. ' $.')
end)