Locales['fr'] = {
  --Global menus
  ['vehicle_belongs']                 = '~g~Concessionaire\n~s~Le véhicule : ~g~%s~s~ ~s~désormais ~g~vous~s~ appartient.',
  ...
  ['car_dealer']                      = 'Concessionnaire | Voiture',
  ...
  ['return_provider_menu']            = 'Retourner le véhicule au fournisseur',
