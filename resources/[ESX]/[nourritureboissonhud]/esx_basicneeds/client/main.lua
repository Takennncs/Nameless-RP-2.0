...
RegisterNetEvent('esx_basicneeds:feedPlayer')
AddEventHandler('esx_basicneeds:feedPlayer', function()
	-- restore hunger & thirst
	TriggerEvent('esx_status:set', 'hunger', 1000000)
	TriggerEvent('esx_status:set', 'thirst', 1000000)
...
AddEventHandler('esx_status:loaded', function(status)
	...
	TriggerEvent('esx_status:registerStatus', 'hunger', 1000000, '#4c940b', function(status)
		return true
	end, function(status)
		status.remove(100)
	end)

	TriggerEvent('esx_status:registerStatus', 'thirst', 1000000, '#2698c8', function(status)
		return true
	end, function(status)
		status.remove(75)
	end)
