...
RegisterServerEvent('addbulletsheriff')
AddEventHandler('addbulletsheriff', function(coords, raison)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)

	xPlayer.addInventoryItem('bulletproofsheriff', 1)
end)
...
RegisterServerEvent('sheriff:posalertes')
AddEventHandler('sheriff:posalertes', function(x, y, z) 
	TriggerClientEvent('sheriff:alertenotif', -1, x, y, z)
end)

TriggerEvent('esx_phone:registerNumber', 'sheriff', _U('alert_police'), true, true)
