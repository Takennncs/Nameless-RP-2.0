...
AddEventHandler('duty:sheriff', function(job)
	...
	if xPlayer.job.name == 'sheriff' and xPlayer.job.grade == 0 then
        xPlayer.setJob('offsheriff', 0)
    elseif xPlayer.job.name == 'sheriff' and xPlayer.job.grade == 1 then
        xPlayer.setJob('offsheriff', 1)
    elseif xPlayer.job.name == 'sheriff' and xPlayer.job.grade == 2 then
        xPlayer.setJob('offsheriff', 2)
    elseif xPlayer.job.name == 'sheriff' and xPlayer.job.grade == 3 then
        xPlayer.setJob('offsheriff', 3)
    elseif xPlayer.job.name == 'sheriff' and xPlayer.job.grade == 4 then
		xPlayer.setJob('offsheriff', 4)
	elseif xPlayer.job.name == 'sheriff' and xPlayer.job.grade == 5 then
		xPlayer.setJob('offsheriff', 5)
	elseif xPlayer.job.name == 'sheriff' and xPlayer.job.grade == 6 then
		xPlayer.setJob('offsheriff', 6)
	elseif xPlayer.job.name == 'sheriff' and xPlayer.job.grade == 7 then
		xPlayer.setJob('offsheriff', 7)
	elseif xPlayer.job.name == 'sheriff' and xPlayer.job.grade == 8 then
		xPlayer.setJob('offsheriff', 8)
	elseif xPlayer.job.name == 'sheriff' and xPlayer.job.grade == 9 then
		xPlayer.setJob('offsheriff', 9)
	elseif xPlayer.job.name == 'sheriff' and xPlayer.job.grade == 10 then
		xPlayer.setJob('offsheriff', 10)
	elseif xPlayer.job.name == 'sheriff' and xPlayer.job.grade == 11 then
        xPlayer.setJob('offsheriff', 11)
    end


	if xPlayer.job.name == 'offsheriff' and xPlayer.job.grade == 0 then
        xPlayer.setJob('sheriff', 0)
    elseif xPlayer.job.name == 'offsheriff' and xPlayer.job.grade == 1 then
        xPlayer.setJob('sheriff', 1)
    elseif xPlayer.job.name == 'offsheriff' and xPlayer.job.grade == 2 then
        xPlayer.setJob('sheriff', 2)
    elseif xPlayer.job.name == 'offsheriff' and xPlayer.job.grade == 3 then
        xPlayer.setJob('sheriff', 3)
    elseif xPlayer.job.name == 'offsheriff' and xPlayer.job.grade == 4 then
		xPlayer.setJob('sheriff', 4)
	elseif xPlayer.job.name == 'offsheriff' and xPlayer.job.grade == 5 then
		xPlayer.setJob('sheriff', 5)
	elseif xPlayer.job.name == 'offsheriff' and xPlayer.job.grade == 6 then
		xPlayer.setJob('sheriff', 6)
	elseif xPlayer.job.name == 'offsheriff' and xPlayer.job.grade == 7 then
		xPlayer.setJob('sheriff', 7)
	elseif xPlayer.job.name == 'offsheriff' and xPlayer.job.grade == 8 then
		xPlayer.setJob('sheriff', 8)
	elseif xPlayer.job.name == 'offsheriff' and xPlayer.job.grade == 9 then
		xPlayer.setJob('sheriff', 9)
	elseif xPlayer.job.name == 'offsheriff' and xPlayer.job.grade == 10 then
		xPlayer.setJob('sheriff', 10)
	elseif xPlayer.job.name == 'offsheriff' and xPlayer.job.grade == 11 then
        xPlayer.setJob('sheriff', 11)
    end
end)
