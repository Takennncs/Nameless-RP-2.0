...
Config.Zones = {
	...
	lscustomsActions = {
		Pos   = {x = -347.0280456543, y = -133.59576416016, z = 39.009620666504-0.98},
	...
	Garage = {
		Pos   = {x = 1759.0,  y = 3326.92,  z = 41.36-0.98},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Color = {r = 0, g = 0, b = 200},
		Type  = 25
	},
	...
	VehicleSpawnPoint = {
		Pos   = {x = -377.88,  y = -106.28,  z = 38.68-0.98},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = {x = -354.48,  y = -115.76,  z = 38.68},
	...
	VehicleDelivery = {
		Pos   = {x = -374.96,  y = -116.68,  z = 38.68-0.98},
