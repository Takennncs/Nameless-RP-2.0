$(document).ready(function () {
	...
	$('.toggletout').on('click', function (e) {
		e.preventDefault();
		$.post('http://menu/toggletout', JSON.stringify({
			id: idEnt
		}));
		$(this).find('.text').text($(this).find('.text').text() == 'Ouvrir toutes les portes' ? 'Fermer toutes les portes' : 'Ouvrir toutes les portes');
	});
	...
	$('.lock').on('click', function (e) {
		...
		$(this).find('.text').text($(this).find('.text').text() == 'Ouvrir/Fermer le véhicule' ? 'Ouvrir/Fermer le véhicule' : 'Ouvrir/Fermer le véhicule');
	});
