...
RegisterNUICallback('toggletout', function(data)
	if(toggleTout == 0)then
		SetVehicleDoorOpen(data.id, 0, false)
		SetVehicleDoorOpen(data.id, 1, false)
		SetVehicleDoorOpen(data.id, 2, false)
		SetVehicleDoorOpen(data.id, 3, false)
		SetVehicleDoorOpen(data.id, 4, false)
		SetVehicleDoorOpen(data.id, 5, false)
		toggleTout = 1
	else
		SetVehicleDoorShut(data.id, 0, false)
		SetVehicleDoorShut(data.id, 1, false)
		SetVehicleDoorShut(data.id, 2, false)
		SetVehicleDoorShut(data.id, 3, false)
		SetVehicleDoorShut(data.id, 4, false)
		SetVehicleDoorShut(data.id, 5, false)
		toggleTout = 0
	end
