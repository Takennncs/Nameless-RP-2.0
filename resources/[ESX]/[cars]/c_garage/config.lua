Config = {}
Config.Blip			= {sprite= 357, color = 26}
Config.BoatBlip		= {sprite= 357, color = 26}
Config.AirplaneBlip	= {sprite= 357, color = 26}
...
Config.Garages = {
	Centre = {
		Pos = {x=215.800, y=-810.057, z=30.82},
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = _U('garage_name'),
		HelpPrompt = _U('open_car_garage'),
		SpawnPoint = {
			Pos = {x=229.700, y= -800.1149, z= 30.946},
			Heading = 160.0,
