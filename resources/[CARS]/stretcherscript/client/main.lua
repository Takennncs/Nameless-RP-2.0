...
local labels = {        
	{ "REDNECK_AMBO_HELP", "Appuyez sur ~INPUT_CONTEXT~ pour ouvrir/fermer les portes.~n~Appuyez sur ~INPUT_HUD_SPECIAL~ pour sortir le chargeur." },
	{ "REDNECK_AMBO_HELP2", "Appuyez sur ~INPUT_CONTEXT~ pour ouvrir/fermer les portes.~n~Appuyez sur ~INPUT_DETONATE~ pour prendre le lit.~n~Appuyez sur ~INPUT_HUD_SPECIAL~ pour sortir le chargeur." },
	{ "REDNECK_AMBO_HELP3", "Appuyez sur ~INPUT_CONTEXT~ pour ouvrir/fermer les portes.~n~Appuyez sur ~INPUT_DETONATE~ pour ranger le lit.~n~Appuyez sur ~INPUT_HUD_SPECIAL~ pour sortir le chargeur." }
}
...
Citizen.CreateThread(function()
	...
	-- WarMenu.SetTitleBackgroundSprite('hopital', 'redneckmods', 'banner')q
	while true do
		local sleep = 2000	
		...
		for _,i in pairs(lit) do
			...
			if DoesEntityExist(closestObject) then
				...
				if WarMenu.IsMenuOpened('hopital') then
					...
					if WarMenu.Button('~r~Fermer le menu') then
