...
function OpenShopInv(shoptype)
    ...
    Citizen.Wait(500)
    TriggerEvent("c_inventaire:openShopInventory", data, inventory)
end
...
RegisterNetEvent("c_inventaire:openShopInventory")
AddEventHandler("c_inventaire:openShopInventory", function(data, inventory)
